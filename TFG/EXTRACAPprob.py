...
with open('lr_extracap.pickle', 'rb') as f:
    lr_modelDic = pickle.load(f)
    lr_model=lr_modelDic['model']

with open('rf_extracap.pickle', 'rb') as f:
