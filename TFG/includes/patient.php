...
$pinag, $margen, $tnm2, $psapos, $rtpadyu, $rtpmes, $rbq, $trbq, $tdupli, $t1mtx, $fechafin, $fallec, $tsuperv, $psafin, $tsegui, $notas, $ay, $az, $capras, $ra, $pten, $erg, $ki67, $spink1, $cmyc;
    ...
    public function __construct($fechacir, $edad, $etnia, $obeso, $hta, $dm, $tabaco, $hereda, $tactor, $psapre, $psalt, $tduppre, $ecotr, $nbiopsia, $histo, $gleason1, $ncilpos, $bilat, $porcent, $iperin,
                                ...
                                $rtpmes, $rbq, $trbq, $tdupli, $t1mtx, $fechafin, $fallec, $tsuperv, $psafin, $tsegui, $notas, $ay, $az, $capras, $ra, $pten, $erg, $ki67, $spink1, $cmyc)
    {
 ...
 */
    public static function registrarPatient($fechacir, $edad, $etnia, $obeso, $hta, $dm, $tabaco, $hereda, $tactor, $psapre, $psalt, $tduppre, $ecotr, $nbiopsia, $histo, $gleason1,
                                            $ncilpos, $bilat, $porcent, $iperin, $ilinf, $ivascu, $tnm1, $histo2, $gleason2, $bilat2, $localiz, $multifoc, $volumen, $extracap, $vvss, $iperin2, $ilinf2, $ivascu2,
                                            $pinag, $margen, $tnm2, $psapos, $rtpadyu, $rtpmes, $rbq, $trbq, $tdupli, $timtx, $fechafin, $fallec, $tsuperv, $psafin, $tsegui, $notas, $ay, $az, $capras, $ra, $pten, $erg, $ki67, $spink1, $cmyc): bool
    {
        $conn = getConexionBD();//corregir %s %d cuando se arregle tema fechas y varchars, añadir otro %d al final para NHIS
            ...
            $query = sprintf("INSERT INTO `patients` (`fechacir`, `edad`, `etnia`, `obeso`, `hta`, `dm`, `tabaco`, `hereda`, `tactor`, `psapre`, `psalt`, `tduppre`, `ecotr`, `nbiopsia`, `histo`
                       ...
                       `tnm2`, `psapos`, `rtpadyu`, `rtpmes`, `rbq`, `trbq`, `tdupli`, `t1mtx`, `fechafin`, `fallec`, `tsuperv`, `psafin`, `tsegui`, `notas`, `ay`, `az`, `capra-s`, `ra`, `pten`, `erg`, `ki-67`, `spink1`, `c-myc`)
                VALUES ('%s', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%s', '%s', '%s', '%d',
                        '%d', '%d', '%d', '%d', '%d', '%s', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%s', '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d',
                        '%s','%d', '%d', '%d', '%d', '%s', '%d', '%s', '%d', '%d', '%s', '%d', '%s', '%s', '%s', '%d', '%d', '%d', '%d', '%d', '%d', '%d')", $conn->real_escape_string($fechacir),
                ...
                $pinag, $margen, $tnm2, $conn->real_escape_string($psapos), $rtpadyu, $rtpmes, $rbq, $trbq, $conn->real_escape_string($tdupli), $timtx, $conn->real_escape_string($fechafin), $fallec, $tsuperv, $conn->real_escape_string($psafin), $tsegui, $conn->real_escape_string($notas), $conn->real_escape_string($ay), $conn->real_escape_string($az), $capras, $ra, $pten, $erg, $ki67, $spink1, $cmyc);
