...
def train_and_evaluate_models(X, y):
    ...
    ax.set_ylabel('Valor')
    ax.set_title('Métricas de evaluación MARGEN (Validación cruzada)')
    ax.set_xticks(x)
    ...
    with open('lr_margen.pickle', 'wb') as f:
        pickle.dump(lr_model, f)

    with open('rf_margen.pickle', 'wb') as f:
        pickle.dump(rf_model, f)
    
print(f"Modelos para MARGEN (Postoperatorio):")
